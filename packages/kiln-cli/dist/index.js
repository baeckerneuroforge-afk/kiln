...
import { KilnApiClient, KilnApiError, getKilnConfigPath, writeStoredConfig } from "./api-client.js";
...
program
    ...
    .action(async (configPath, command) => {
...
program
    ...
    .action(async (agentId, message, options, command) => {
    const client = await getClient(command);
