...
export default function SubmitNodePage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        <h1 className="text-2xl font-serif text-stone-100">Custom Node einreichen</h1>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-1.5">
          <Label className="text-xs text-stone-400">Beschreibung</Label>
          <Textarea
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="space-y-1.5">
            <Label className="text-xs text-stone-400">Kategorie</Label>
          ...
          <div className="space-y-1.5">
            <Label className="text-xs text-stone-400">Icon (Emoji)</Label>
            <Input
              value={form.icon}
          ...
          <div className="space-y-1.5">
            <Label className="text-xs text-stone-400">Farbe</Label>
            <div className="flex gap-2">
              <Input
                type="color"
                value={form.color}
                onChange={(e) => setForm({ ...form, color: e.target.value })}
                className="w-10 h-9 p-1 bg-stone-900 border-stone-700"
              />
              <Input
                value={form.color}
                onChange={(e) => setForm({ ...form, color: e.target.value })}
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-between">
            <Label className="text-xs text-stone-400">Execute Code</Label>
          ...
          <Textarea
            ...
            className="bg-stone-900 border-stone-700 font-mono text-xs min-h-[200px]"
        ...
        <div className="space-y-1.5">
          <Label className="text-xs text-stone-400">Readme (optional, Markdown)</Label>
          <Textarea
            value={form.readme}
            onChange={(e) => setForm({ ...form, readme: e.target.value })}
            className="bg-stone-900 border-stone-700 min-h-[100px]"
