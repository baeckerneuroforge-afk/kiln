  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold text-zinc-100">Client Portale</h2>
      ...
      {portals.length === 0 && !showCreate ? (
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-8 text-center">
          ...
          <h3 className="mb-1 text-sm font-semibold text-zinc-100">Noch keine Portale</h3>
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-zinc-100">{portal.name}</h3>
                    <div className="flex items-center gap-2 mt-0.5">
                      <span className="text-xs text-zinc-500">{portal.clientEmail}</span>
                      {portal.clientName && (
                        <span className="text-xs text-zinc-600">· {portal.clientName}</span>
                      )}
                    </div>
                  </div>
                </div>
