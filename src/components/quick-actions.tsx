        ...
        return (
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <ArrowRight className="h-4 w-4 text-zinc-600 transition-transform duration-200 group-hover:translate-x-0.5 group-hover:text-zinc-400" />
            </div>
    ...
    <div className="rounded-xl border border-zinc-800 bg-zinc-900/60">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center px-5 py-10 text-center">
          <Bot className="mb-3 h-8 w-8 text-zinc-700" />
          ...
          {events.slice(0, 5).map((event) => {
            ...
            return (
              <li key={event.id}>
                <Link
                  href={event.href}
                  className="flex items-center gap-3 px-5 py-3 transition-colors hover:bg-zinc-800/40"
                >
                  ...
                  <ArrowRight className="h-3.5 w-3.5 flex-shrink-0 text-zinc-700" />
                </Link>
              </li>
            );
          })}
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      {agentActions.map(({ label, icon: Icon, action }) => {
        const shared = cn(
          "inline-flex items-center gap-1.5 rounded-lg border border-zinc-800 bg-zinc-900/60 px-3 py-2 text-xs font-medium text-zinc-300",
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-orange-500/20 bg-gradient-to-br from-orange-500/5 to-transparent p-8">
        <h2 className="font-serif text-2xl text-zinc-100">Welcome to KILN</h2>
          ...
          {pathCards.map((card) => {
            ...
            return (
              <Link
                ...
                href={card.href}
                className={cn(
                  "group flex flex-col gap-3 rounded-xl border border-zinc-800 bg-zinc-900/60 p-5",
        ...
        {/* Featured Template */}
        <div className="mt-6 flex flex-col items-start gap-4 rounded-xl border border-zinc-800 bg-zinc-900/60 p-5 sm:flex-row sm:items-center sm:justify-between">
