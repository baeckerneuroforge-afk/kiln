  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-1.5">
        <label className="text-xs font-medium text-muted-foreground">Monitored URLs</label>
        {urls.map((url, i) => (
          <div key={i} className="flex items-center gap-2">
            <input
              ...
              className="flex-1 rounded-lg border border-border bg-card/50 px-3 py-1.5 text-xs text-foreground focus:border-blue-500/50 focus:outline-none"
            />
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="flex-1 rounded-lg border border-border bg-card/50 px-3 py-1.5 text-xs text-muted-foreground placeholder:text-muted-foreground focus:border-blue-500/50 focus:outline-none"
          />
          <button onClick={addUrl} className="p-1 text-muted-foreground hover:text-blue-400">
      ...
      <div className="space-y-1.5">
        ...
        <select
          ...
          className="w-full rounded-lg border border-border bg-card/50 px-3 py-1.5 text-xs text-foreground focus:border-blue-500/50 focus:outline-none"
        >
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-0.5">
          <label className="text-xs font-medium text-muted-foreground">Continue if no changes</label>
        ...
        <button
          ...
          className={`h-5 w-9 rounded-full transition-colors ${continueIfNoChanges ? "bg-blue-500" : "bg-muted"}`}
        >
